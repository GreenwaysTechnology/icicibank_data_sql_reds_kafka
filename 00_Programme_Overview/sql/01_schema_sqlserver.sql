-- =====================================================================
--  ICICI BANK  |  Core Banking Schema  |  SQLSERVER
...
IF OBJECT_ID('loan_payment','U') IS NOT NULL DROP TABLE loan_payment;
IF OBJECT_ID('loan','U') IS NOT NULL DROP TABLE loan;
IF OBJECT_ID('account_txn','U') IS NOT NULL DROP TABLE account_txn;
